...
public class Bank {
    ...
    /**
     * Adds 1 to total accounts each time an account is opened.
     */
    ...
    public static void main(final String[] unused) {
        ...
        System.out.println("Bank account for Johnny Ive created\n\n");

        // Deposit money to both accounts and print new balance
        bank.depositMoney(account1, 1000.0);
        bank.depositMoney(account2, 5000.0);

        System.out.println(account1.getAccountBalance() + " John");
        System.out.println(account2.getAccountBalance() + " Johnny Ive");
